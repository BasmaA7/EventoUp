<aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
  ...
  <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
    <ul class="flex flex-col pl-0 mb-0">
      ...
      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="{{route('my_event')}}">
          ...
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Manage Event</span>
        </a>
      </li>


      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="{{route('ManageTickets')}}">
          ...
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Manage Tickets</span>
        </a>
      </li>
      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="{{route('categories.index')}}">
          ...
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Manage Categories</span>
        </a>
      </li>
  ...
  <div class="mx-4">
    ...
    <p class="invisible hidden  text-red-500  after:bg-gradient-to-tl  after:to-slate-800 "></p>
